...
class TestBridgeInit:
    ...
    def test_not_available_without_config(self):
        ...
        with patch.object(home, "CONFIG_FILE", Path("nonexistent/ha.json")):
    ...
    def test_available_with_config(self, ha_config):
        ...
        with patch.object(home, "CONFIG_FILE", ha_config):
            bridge = home.HomeAssistantBridge()
...
class TestDeviceActions:
    ...
    @patch("jarvis_home.requests.post")
...
class TestGetState:
    ...
    @patch("jarvis_home.requests.get")
